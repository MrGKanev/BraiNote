 ...
 *
 * @see org.brainote.utils.systemui.SystemUiHider
 */
public class GalleryActivity extends ActionBarActivity {
    ...
    /**
     * The flags to pass to {@link org.brainote.utils.systemui.SystemUiHider#getInstance}.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.brainote.R.layout.activity_gallery);
        mActivity = this;

//		final View controlsView = findViewById(R.id.fullscreen_content_controls);
        final View contentView = findViewById(org.brainote.R.id.fullscreen_content);
...
//		findViewById(R.id.dummy_button).setOnTouchListener(mDelayHideTouchListener);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(org.brainote.R.menu.menu_gallery, menu);
        return true;
    }
    ...
    private void initViews() {
        ...
        ((InterceptorFrameLayout) findViewById(org.brainote.R.id.gallery_root)).setOnViewTouchedListener(screenTouches);

        mViewPager = (GalleryViewPager) findViewById(org.brainote.R.id.fullscreen_content);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                onBackPressed();
                break;
            case org.brainote.R.id.menu_gallery_share: {
                shareMedia();
                break;
            }
            case org.brainote.R.id.menu_gallery: {
                viewMedia();
                break;
            }
        }
