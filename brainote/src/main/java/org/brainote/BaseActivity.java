...
import org.brainote.widget.ListWidgetProvider;
...
//			GoogleAnalytics.getInstance(this).setDryRun(true);
    ...
    protected void onResume() {
        super.onResume();
        // Navigation selected
        String navNotes = getResources().getStringArray(org.brainote.R.array.navigation_list_codes)[0];
    ...
    public static void requestPassword(final Activity mActivity, final PasswordValidator mPasswordValidator) {
        ...
        final View v = inflater.inflate(org.brainote.R.layout.password_request_dialog_layout, null);
        final EditText passwordEditText = (EditText) v.findViewById(org.brainote.R.id.password_request);

        MaterialDialog dialog = new MaterialDialog.Builder(mActivity)
                .autoDismiss(false)
                .title(org.brainote.R.string.insert_security_password)
                .customView(v)
                ...
                .callback(new MaterialDialog.SimpleCallback() {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        ...
                        if (result) {
                            ...
                            passwordEditText.setError(mActivity.getString(org.brainote.R.string.wrong_password));
                        }
                    }
                }).build();
...
//	}
    ...
    public static void notifyAppWidgets(Context mActivity) {
        ...
        mgr.notifyAppWidgetViewDataChanged(ids, org.brainote.R.id.widget_list);
    ...
    protected void animateTransition(FragmentTransaction transaction, int direction) {
        if (direction == TRANSITION_HORIZONTAL) {
            transaction.setCustomAnimations(org.brainote.R.animator.fade_in_support, org.brainote.R.animator.fade_out_support,
                    org.brainote.R.animator.fade_in_support, org.brainote.R.animator.fade_out_support);
        }
        if (direction == TRANSITION_VERTICAL && Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            transaction.setCustomAnimations(
                    org.brainote.R.animator.anim_in, org.brainote.R.animator.anim_out, org.brainote.R.animator.anim_in_pop, org.brainote.R.animator.anim_out_pop);
        }
    }
