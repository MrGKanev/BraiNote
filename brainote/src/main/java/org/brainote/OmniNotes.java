...
import org.brainote.utils.BitmapCache;
...
@ReportsCrashes(formKey = "", httpMethod = Method.PUT, reportType = Type.JSON, 
        ...
        mode = ReportingInteractionMode.DIALOG, resDialogCommentPrompt = org.brainote.R.string.crash_dialog_comment_prompt,
        resDialogText = org.brainote.R.string.crash_dialog_text)
