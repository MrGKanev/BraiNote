...
import org.brainote.models.listeners.OnPushBulletReplyListener;
...
public class MainActivity extends BaseActivity implements OnDateSetListener, OnTimeSetListener, 
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.brainote.R.layout.activity_main);
...
//		requestShowCaseViewVisualization();
    ...
    private void initUI() {
        toolbar = (Toolbar) findViewById(org.brainote.R.id.toolbar);
    ...
    private void init() {
        ...
        NavigationDrawerFragment mNavigationDrawerFragment = (NavigationDrawerFragment) mFragmentManager
                .findFragmentById(org.brainote.R.id.navigation_drawer);
        if (mNavigationDrawerFragment == null) {
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            fragmentTransaction.replace(org.brainote.R.id.navigation_drawer, new NavigationDrawerFragment(),
                    FRAGMENT_DRAWER_TAG).commit();
        }

        if (mFragmentManager.findFragmentByTag(FRAGMENT_LIST_TAG) == null) {
            FragmentTransaction fragmentTransaction = mFragmentManager.beginTransaction();
            fragmentTransaction.add(org.brainote.R.id.fragment_container, new ListFragment(), FRAGMENT_LIST_TAG).commit();
        }
    ...
    public MenuItem getSearchMenuItem() {
        Fragment f = checkFragmentInstance(org.brainote.R.id.fragment_container, ListFragment.class);
        if (f != null) {
    ...
    public void initNavigationDrawer() {
        Fragment f = checkFragmentInstance(org.brainote.R.id.navigation_drawer, NavigationDrawerFragment.class);
    ...
    public void onBackPressed() {
        ...
        // SketchFragment
        f = checkFragmentInstance(org.brainote.R.id.fragment_container, SketchFragment.class);
        if (f != null) {
        ...
        // DetailFragment
        f = checkFragmentInstance(org.brainote.R.id.fragment_container, DetailFragment.class);
        if (f != null) {
        ...
        // ListFragment
        f = checkFragmentInstance(org.brainote.R.id.fragment_container, ListFragment.class);
        if (f != null) {
    ...
    public DrawerLayout getDrawerLayout() {
        return ((DrawerLayout) findViewById(org.brainote.R.id.drawer_layout));
    }


    public ActionBarDrawerToggle getDrawerToggle() {
        if (mFragmentManager != null && mFragmentManager.findFragmentById(org.brainote.R.id.navigation_drawer) != null) {
            return ((NavigationDrawerFragment) mFragmentManager.findFragmentById(org.brainote.R.id.navigation_drawer)).mDrawerToggle;
        } else {
            return null;
        }
    }
    ...
    private void saveAndExit(Intent i) {
        ...
        showToast(getString(org.brainote.R.string.note_updated), Toast.LENGTH_SHORT);
        finish();
    }
    ...
    public void switchToList() {
        ...
        transaction.replace(org.brainote.R.id.fragment_container, mListFragment, FRAGMENT_LIST_TAG).addToBackStack
    ...
    public void switchToDetail(Note note) {
        ...
        if (mFragmentManager.findFragmentByTag(FRAGMENT_DETAIL_TAG) == null) {
            transaction.replace(org.brainote.R.id.fragment_container, mDetailFragment, FRAGMENT_DETAIL_TAG).addToBackStack
    ...
    public void shareNote(Note note) {
        ...
        startActivity(Intent.createChooser(shareIntent, getResources().getString(org.brainote.R.string.share_message_chooser)));
    }
...
//    }
    ...
    void showMessage(String message, Style style) {
        if (croutonViewContainer == null) {
            ...
            croutonViewContainer = (ViewGroup) findViewById(org.brainote.R.id.crouton_handle);
        }
