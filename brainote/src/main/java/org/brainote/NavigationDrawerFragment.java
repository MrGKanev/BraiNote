...
import org.brainote.models.NavigationItem;
import org.brainote.models.ONStyle;
import org.brainote.models.adapters.NavDrawerAdapter;
import org.brainote.models.views.NonScrollableListView;
import org.brainote.utils.Constants;
import org.brainote.utils.Display;
...
public class NavigationDrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(org.brainote.R.layout.fragment_navigation_drawer, container, false);
    }
    ...
    public void init() {
        ...
        mDrawerLayout = (DrawerLayout) mActivity.findViewById(org.brainote.R.id.drawer_layout);
        mDrawerLayout.setFocusableInTouchMode(false);

        // Setting specific bottom margin for Kitkat with translucent nav bar
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            View leftDrawer = getView().findViewById(org.brainote.R.id.left_drawer);
        ...
        mDrawerToggle = new ActionBarDrawerToggle(mActivity,
                ...
                org.brainote.R.string.drawer_open,
                org.brainote.R.string.drawer_close
        ) {
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                mActivity.getSupportActionBar().setTitle(mActivity.getApplicationContext().getString(org.brainote.R.string
                        .app_name));
...
//				}
        ...
        // just styling option
        mDrawerLayout.setDrawerShadow(org.brainote.R.drawable.drawer_shadow, GravityCompat.START);
    ...
    private void buildCategoriesMenu() {
        ...
        mDrawerCategoriesList = (NonScrollableListView) getView().findViewById(org.brainote.R.id.drawer_tag_list);
        ...
        if (categoriesListHeader == null) {
            categoriesListHeader = inflater.inflate(org.brainote.R.layout.drawer_category_list_header, null);
        }

        // Inflation of Settings view
        if (settingsView == null) {
            settingsView = ((ViewStub) getActivity().findViewById(org.brainote.R.id.settings_placeholder)).inflate();
        ...
        if (settingsViewCat == null) {
            settingsViewCat = inflater.inflate(org.brainote.R.layout.drawer_category_list_footer, null);
            Fonts.overrideTextSize(mActivity,
                    mActivity.getSharedPreferences(Constants.PREFS_NAME, getActivity().MODE_MULTI_PROCESS),
                    settingsViewCat);
        }
    ...
    private void buildMainMenu() {
        ...
        mDrawerList = (NonScrollableListView) getView().findViewById(org.brainote.R.id.drawer_nav_list);
        mNavigationArray = getResources().getStringArray(org.brainote.R.array.navigation_list);
        mNavigationIconsArray = getResources().obtainTypedArray(org.brainote.R.array.navigation_list_icons);
        mNavigationIconsSelectedArray = getResources().obtainTypedArray(org.brainote.R.array.navigation_list_icons_selected);
        ...
        mDrawerList.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
                mActivity.commitPending();
                String navigation = getResources().getStringArray(org.brainote.R.array.navigation_list_codes)[items.get(position)
                        .getArrayIndex()];
