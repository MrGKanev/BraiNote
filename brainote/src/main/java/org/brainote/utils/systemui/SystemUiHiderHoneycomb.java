...
public class SystemUiHiderHoneycomb extends SystemUiHiderBase {
    ...
    /**
     * Flags to test against the first parameter in {@link android.view.View
     * * .OnSystemUiVisibilityChangeListener#onSystemUiVisibilityChange(int)} to determine the system UI visibility 
     * * state.
     */
    private int mTestFlags;

    /**
     * Whether or not the system UI is currently visible. This is cached from {@link android.view.View
    ...
    protected SystemUiHiderHoneycomb(Activity activity, View anchorView, int flags) {
        ...
        if ((mFlags & FLAG_FULLSCREEN) != 0) {
            ...
            mHideFlags |= View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | View
        ...
        if ((mFlags & FLAG_HIDE_NAVIGATION) != 0) {
            ...
            mTestFlags |= View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION;
        }
    }
