...
import org.brainote.models.listeners.OnDrawChangedListener;
import org.brainote.models.views.SketchView;
...
//			}			
//		}		
        return inflater.inflate(org.brainote.R.layout.fragment_sketch, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mSketchView = (SketchView) getActivity().findViewById(org.brainote.R.id.drawing);
        ...
        if (getMainActivity().getSupportActionBar() != null) {
            ...
            getMainActivity().getSupportActionBar().setTitle(org.brainote.R.string.title_activity_sketch);
            getMainActivity().getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        }

        stroke = (ImageView) getActivity().findViewById(org.brainote.R.id.sketch_stroke);
        ...
        eraser = (ImageView) getActivity().findViewById(org.brainote.R.id.sketch_eraser);
        AlphaManager.setAlpha(eraser, 0.4f);
        ...
        undo = (ImageView) getActivity().findViewById(org.brainote.R.id.sketch_undo);
        ...
        redo = (ImageView) getActivity().findViewById(org.brainote.R.id.sketch_redo);
        ...
        erase = (ImageView) getActivity().findViewById(org.brainote.R.id.sketch_erase);
        erase.setOnClickListener(new OnClickListener() {
            ...
            private void askForErase() {
                ...
                alertDialogBuilder.setMessage(org.brainote.R.string.erase_sketch)
...
// .layout_root));
        popupLayout = inflater.inflate(org.brainote.R.layout.popup_sketch_stroke, null);
...
// (ViewGroup) getActivity().findViewById(R.id.layout_root));
        popupEraserLayout = inflaterEraser.inflate(org.brainote.R.layout.popup_sketch_eraser, null);

        // Actual stroke shape size is retrieved
        strokeImageView = (ImageView) popupLayout.findViewById(org.brainote.R.id.stroke_circle);
        final Drawable circleDrawable = getResources().getDrawable(org.brainote.R.drawable.circle);
        size = circleDrawable.getIntrinsicWidth();
        // Actual eraser shape size is retrieved
        eraserImageView = (ImageView) popupEraserLayout.findViewById(org.brainote.R.id.stroke_circle);
//		final Drawable circleEraserDrawable = getResources().getDrawable(R.drawable.circle);
        ...
        mColorPicker = (ColorPicker) popupLayout.findViewById(org.brainote.R.id.stroke_color_picker);
        mColorPicker.addSVBar((SVBar) popupLayout.findViewById(org.brainote.R.id.svbar));
        mColorPicker.addOpacityBar((OpacityBar) popupLayout.findViewById(org.brainote.R.id.opacitybar));
...
//		popup.showAsDropDown(anchor, 0, DensityUtil.convertDpToPixel(isErasing ? -120 : -390, getActivity()));
        ...
        mSeekBar = (SeekBar) (isErasing ? popupEraserLayout
                .findViewById(org.brainote.R.id.stroke_seekbar) : popupLayout
                .findViewById(org.brainote.R.id.stroke_seekbar));
