...
public class CategoryActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(org.brainote.R.layout.activity_category);
...
//	}
    ...
    private void initViews() {
        title = (EditText) findViewById(org.brainote.R.id.category_title);
        description = (EditText) findViewById(org.brainote.R.id.category_description);
        picker = (ColorPicker) findViewById(org.brainote.R.id.colorpicker_category);
        ...
        SaturationBar saturationbar = (SaturationBar) findViewById(org.brainote.R.id.saturationbar_category);
        saturationbar.setSaturation(SATURATION);
        picker.addSaturationBar(saturationbar);
        ValueBar valuebar = (ValueBar) findViewById(org.brainote.R.id.valuebar_category);
        valuebar.setValue(VALUE);
        picker.addValueBar(valuebar);

        deleteBtn = (Button) findViewById(org.brainote.R.id.delete);
        saveBtn = (Button) findViewById(org.brainote.R.id.save);
        ...
        saveBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (title.getText().toString().length() > 0) {
                    ...
                    title.setError(getString(org.brainote.R.string.category_missing_title));
                }
            }
        });
...
//		}		
    ...
    private void deleteCategory() {
        ...
        String msg;
        if (count > 0)
            msg = getString(org.brainote.R.string.delete_category_confirmation).replace("$1$", String.valueOf(count));
        else
            msg = getString(org.brainote.R.string.delete_unused_category_confirmation);
