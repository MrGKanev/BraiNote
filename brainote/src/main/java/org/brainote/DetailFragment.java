...
import org.brainote.async.AttachmentTask;
...
import org.brainote.models.Tag;
import org.brainote.models.adapters.AttachmentAdapter;
import org.brainote.models.listeners.OnReminderPickedListener;
import org.brainote.utils.AlphaManager;
import org.brainote.utils.ConnectionManager;
import org.brainote.utils.Constants;
import org.brainote.utils.FileHelper;
import org.brainote.utils.Fonts;
import org.brainote.utils.GeocodeHelper;
import org.brainote.utils.IntentChecker;
import org.brainote.utils.KeyboardUtils;
import org.brainote.utils.ReminderHelper;
import org.brainote.utils.ShortcutHelper;
import org.brainote.utils.StorageManager;
import org.brainote.utils.TagsHelper;
import org.brainote.utils.TextHelper;
import org.brainote.utils.date.DateHelper;
...
import org.brainote.async.SaveNoteTask;
import org.brainote.db.DbHelper;
import org.brainote.models.adapters.NavDrawerCategoryAdapter;
import org.brainote.models.adapters.PlacesAutoCompleteAdapter;
import org.brainote.models.listeners.OnAttachingFileListener;
import org.brainote.models.listeners.OnGeoUtilResultListener;
import org.brainote.models.listeners.OnNoteSaved;
import org.brainote.models.views.ExpandableHeightGridView;
import org.brainote.utils.date.ReminderPickers;
...
public class DetailFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(org.brainote.R.layout.fragment_detail, container, false);
    }
    ...
    private void handleIntents() {
        ...
        if (Constants.ACTION_SHORTCUT.equals(i.getAction())
            ...
            if (noteOriginal == null) {
                getMainActivity().showToast(getText(org.brainote.R.string.shortcut_note_deleted), Toast.LENGTH_LONG);
                getActivity().finish();
            }
            note = new Note(noteOriginal);
    ...
    private void initViews() {
        ...
        root = (ViewGroup) getView().findViewById(org.brainote.R.id.detail_root);
        root.setOnTouchListener(this);

        // ScrollView container
        scrollView = (ScrollView) getView().findViewById(org.brainote.R.id.content_wrapper);

        // Title view card container
        titleCardView = root.findViewById(org.brainote.R.id.detail_tile_card);
        ...
        locationTextView = (TextView) getView().findViewById(org.brainote.R.id.location);
        ...
        locationTextView.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                builder.content(org.brainote.R.string.remove_location);
                builder.positiveText(org.brainote.R.string.ok);
        ...
        // shown
        mGridView = (ExpandableHeightGridView) getView().findViewById(org.brainote.R.id.gridview);
            ...
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                if (Constants.MIME_TYPE_FILES.equals(attachment.getMime_type())) {
                    ...
                    if (IntentChecker.isAvailable(getActivity().getApplicationContext(), attachmentIntent, null)) {
                        ...
                        getMainActivity().showMessage(org.brainote.R.string.feature_not_available_on_this_device, ONStyle.WARN);
                    }
                    ...
                    noteTmp.setTitle(getNoteTitle());
                    noteTmp.setContent(getNoteContent());
                    String title = TextHelper.parseTitleAndContent(getActivity(),
                            noteTmp)[0].toString();
                    // Images
                    int clickedImage = 0;
        ...
        mGridView.setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View v, final int position, long id) {
                ...
                MaterialDialog.Builder dialogBuilder = new MaterialDialog.Builder(getActivity())
                        .positiveText(org.brainote.R.string.delete);
                ...
                if (Constants.MIME_TYPE_SKETCH.equals(mAttachmentAdapter.getItem(position).getMime_type())) {
                    dialogBuilder
                            .content(org.brainote.R.string.delete_selected_image)
                            .negativeText(org.brainote.R.string.edit)
        ...
        reminder_layout = (LinearLayout) getView().findViewById(org.brainote.R.id.reminder_layout);
        ...
        reminder_layout.setOnLongClickListener(new OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                        .content(org.brainote.R.string.remove_reminder)
        ...
        // Reminder
        datetime = (TextView) getView().findViewById(org.brainote.R.id.datetime);
        datetime.setText(dateTimeText);

        // Timestamps view
        timestampsView = getActivity().findViewById(org.brainote.R.id.detail_timestamps);
        // Bottom padding set for translucent navbar in Kitkat
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            int navBarHeight = org.brainote.utils.Display.getNavigationBarHeightKitkat(getActivity());
        ...
        TextView creationTextView = (TextView) getView().findViewById(org.brainote.R.id.creation);
        String creation = noteTmp.getCreationShort(getActivity());
        creationTextView.append(creation.length() > 0 ? getString(org.brainote.R.string.creation) + " "
                + creation : "");
        if (creationTextView.getText().length() == 0)
            creationTextView.setVisibility(View.GONE);

        // ... and last modification
        TextView lastModificationTextView = (TextView) getView().findViewById(org.brainote.R.id.last_modification);
        String lastModification = noteTmp.getLastModificationShort(getActivity());
        lastModificationTextView.append(lastModification.length() > 0 ? getString(org.brainote.R.string.last_update) + " "
                + lastModification : "");
    ...
    private EditText initTitle() {
        EditText title = (EditText) getView().findViewById(org.brainote.R.id.detail_title);
...
//					((View)event.getLocalState()).setVisibility(View.VISIBLE);
    ...
    private EditText initContent() {
        EditText content = (EditText) getView().findViewById(org.brainote.R.id.detail_content);
    ...
    private void setTagMarkerColor(Category tag) {
        ...
        if (!colorsPref.equals("disabled")) {
            ...
            if (colorsPref.equals("complete")) {
                target.add(getView().findViewById(org.brainote.R.id.title_wrapper));
                target.add(getView().findViewById(org.brainote.R.id.content_wrapper));
            } else {
                target.add(getView().findViewById(org.brainote.R.id.tag_marker));
            }
    ...
    private void setAddress() {
        ...
        View v = inflater.inflate(org.brainote.R.layout.dialog_location, null);
        final AutoCompleteTextView autoCompView = (AutoCompleteTextView) v.findViewById(org.brainote.R.id.auto_complete_location);
        autoCompView.setHint(getString(org.brainote.R.string.search_location));
        autoCompView.setAdapter(new PlacesAutoCompleteAdapter(getActivity(), org.brainote.R.layout.simple_text_layout));
        final MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .customView(autoCompView, false)
                .positiveText(org.brainote.R.string.use_current_location)
                .callback(new MaterialDialog.SimpleCallback() {
                    @Override
                    public void onPositive(MaterialDialog materialDialog) {
        ...
        autoCompView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (s.length() != 0) {
                    dialog.setActionButton(DialogAction.POSITIVE, getString(org.brainote.R.string.confirm));
                } else {
                    dialog.setActionButton(DialogAction.POSITIVE, getString(org.brainote.R.string.use_current_location));
                }
            }
    ...
    public void onAddressResolved(String address) {
        if (TextUtils.isEmpty(address)) {
            if (!isNoteLocationValid()) {
                getMainActivity().showMessage(org.brainote.R.string.location_not_found, ONStyle.ALERT);
                return;
            }
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        inflater.inflate(org.brainote.R.menu.menu_detail, menu);
...
//        }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        MenuItem searchMenuItem = menu.findItem(org.brainote.R.id.menu_search);
        ...
        menu.findItem(org.brainote.R.id.menu_checklist_on).setVisible(!noteTmp.isChecklist());
        menu.findItem(org.brainote.R.id.menu_checklist_off).setVisible(noteTmp.isChecklist());
        menu.findItem(org.brainote.R.id.menu_lock).setVisible(!noteTmp.isLocked());
        menu.findItem(org.brainote.R.id.menu_unlock).setVisible(noteTmp.isLocked());
        // If note is trashed only this options will be available from menu
        if (noteTmp.isTrashed()) {
            menu.findItem(org.brainote.R.id.menu_untrash).setVisible(true);
            menu.findItem(org.brainote.R.id.menu_delete).setVisible(true);
            // Otherwise all other actions will be available
        } else {
            menu.findItem(org.brainote.R.id.menu_add_shortcut).setVisible(!newNote);
            menu.findItem(org.brainote.R.id.menu_archive).setVisible(!newNote && !noteTmp.isArchived());
            menu.findItem(org.brainote.R.id.menu_unarchive).setVisible(!newNote && noteTmp.isArchived());
            menu.findItem(org.brainote.R.id.menu_trash).setVisible(!newNote);
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case android.R.id.home:
                navigateUp();
                break;
            case org.brainote.R.id.menu_attachment:
                showPopup(getActivity().findViewById(org.brainote.R.id.menu_attachment));
                break;
            case org.brainote.R.id.menu_tag:
                addTags();
                break;
            case org.brainote.R.id.menu_category:
                categorizeNote();
                break;
            case org.brainote.R.id.menu_share:
                shareNote();
                break;
            case org.brainote.R.id.menu_checklist_on:
                toggleChecklist();
                break;
            case org.brainote.R.id.menu_checklist_off:
                toggleChecklist();
                break;
            case org.brainote.R.id.menu_lock:
                lockNote();
                break;
            case org.brainote.R.id.menu_unlock:
                lockNote();
                break;
            case org.brainote.R.id.menu_add_shortcut:
                addShortcut();
                break;
            case org.brainote.R.id.menu_archive:
                archiveNote(true);
                break;
            case org.brainote.R.id.menu_unarchive:
                archiveNote(false);
                break;
            case org.brainote.R.id.menu_trash:
                trashNote(true);
                break;
            case org.brainote.R.id.menu_untrash:
                trashNote(false);
                break;
            case org.brainote.R.id.menu_discard_changes:
                discard();
                break;
            case org.brainote.R.id.menu_delete:
                deleteNote();
                break;
        }
    ...
    private void toggleChecklist() {
        ...
        final View layout = inflater.inflate(org.brainote.R.layout.dialog_remove_checklist_layout,
                (ViewGroup) getView().findViewById(org.brainote.R.id.layout_root));

        // Retrieves options checkboxes and initialize their values
        final CheckBox keepChecked = (CheckBox) layout.findViewById(org.brainote.R.id.checklist_keep_checked);
        final CheckBox keepCheckmarks = (CheckBox) layout.findViewById(org.brainote.R.id.checklist_keep_checkmarks);
    ...
    private void toggleChecklist2(final boolean keepChecked, final boolean showChecks) {
        ...
        mChecklistManager.setNewEntryHint(getString(org.brainote.R.string.checklist_item_hint));
    ...
    private void categorizeNote() {
        ...
        final MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .title(org.brainote.R.string.categorize_as)
                .adapter(new NavDrawerCategoryAdapter(getActivity(), categories))
                .positiveText(org.brainote.R.string.add_category)
                .negativeText(org.brainote.R.string.remove_category)
                .callback(new MaterialDialog.Callback() {
                    @Override
    ...
    private void showPopup(View anchor) {
        ...
        // Inflate the popup_layout.xml
        LayoutInflater inflater = (LayoutInflater) getActivity().getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        View layout = inflater.inflate(org.brainote.R.layout.attachment_dialog, null);
        ...
        // Camera
        android.widget.TextView cameraSelection = (android.widget.TextView) layout.findViewById(org.brainote.R.id.camera);
        cameraSelection.setOnClickListener(new AttachmentOnClickListener());
        // Audio recording
        android.widget.TextView recordingSelection = (android.widget.TextView) layout.findViewById(org.brainote.R.id.recording);
        recordingSelection.setOnClickListener(new AttachmentOnClickListener());
        // Video recording
        android.widget.TextView videoSelection = (android.widget.TextView) layout.findViewById(org.brainote.R.id.video);
        videoSelection.setOnClickListener(new AttachmentOnClickListener());
        // Files
        android.widget.TextView filesSelection = (android.widget.TextView) layout.findViewById(org.brainote.R.id.files);
        filesSelection.setOnClickListener(new AttachmentOnClickListener());
        // Sketch
        android.widget.TextView sketchSelection = (android.widget.TextView) layout.findViewById(org.brainote.R.id.sketch);
        sketchSelection.setOnClickListener(new AttachmentOnClickListener());
        // Location
        android.widget.TextView locationSelection = (android.widget.TextView) layout.findViewById(org.brainote.R.id.location);
        locationSelection.setOnClickListener(new AttachmentOnClickListener());
        // Desktop note with PushBullet
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            android.widget.TextView pushbulletSelection = (android.widget.TextView) layout.findViewById(org.brainote.R.id
                    .pushbullet);
        ...
        try {
            ...
            getMainActivity().showMessage(org.brainote.R.string.error, ONStyle.ALERT);
    ...
    private void takePhoto() {
        ...
        if (!IntentChecker.isAvailable(getActivity(), intent, new String[]{PackageManager.FEATURE_CAMERA})) {
            getMainActivity().showMessage(org.brainote.R.string.feature_not_available_on_this_device, ONStyle.ALERT);
    ...
    private void takeSketch(Attachment attachment) {
        ...
        transaction.replace(org.brainote.R.id.fragment_container, mSketchFragment, getMainActivity().FRAGMENT_SKETCH_TAG)
        ...
        if (resultCode == Activity.RESULT_OK) {
            switch (requestCode) {
                ...
                case SKETCH:
                    ...
                    break;
                case TAG:
                    getMainActivity().showMessage(org.brainote.R.string.category_saved, ONStyle.CONFIRM);
                    Category tag = intent.getParcelableExtra("tag");
                    noteTmp.setCategory(tag);
                    setTagMarkerColor(tag);
                    break;
                case DETAIL:
                    getMainActivity().showMessage(org.brainote.R.string.note_updated, ONStyle.CONFIRM);
                    break;
            }
        }
    }
    ...
    private void archiveNote(boolean archive) {
        ...
        goBack = true;
        exitMessage = archive ? getString(org.brainote.R.string.note_archived) : getString(org.brainote.R.string.note_unarchived);
    ...
    private void trashNote(boolean trash) {
        ...
        goBack = true;
        exitMessage = trash ? getString(org.brainote.R.string.note_trashed) : getString(org.brainote.R.string.note_untrashed);
    ...
    private void deleteNote() {
        new MaterialDialog.Builder(getActivity())
                .content(org.brainote.R.string.delete_note_confirmation)
                .positiveText(org.brainote.R.string.ok)
                .callback(new MaterialDialog.SimpleCallback() {
                    @Override
                    public void onPositive(MaterialDialog materialDialog) {
                        ...
                        getMainActivity().showMessage(org.brainote.R.string.note_deleted, ONStyle.ALERT);
                        MainActivity.notifyAppWidgets(getActivity());
                        goHome();
                    }
                }).build().show();
    ...
    public void saveAndExit(OnNoteSaved mOnNoteSaved) {
        exitMessage = getString(org.brainote.R.string.note_updated);
    ...
    void saveNote(OnNoteSaved mOnNoteSaved) {
        ...
        if (goBack && TextUtils.isEmpty(noteTmp.getTitle()) && TextUtils.isEmpty(noteTmp.getContent())
            ...
            exitMessage = getString(org.brainote.R.string.empty_note_not_saved);
    ...
    private String getNoteTitle() {
        String res = "";
        if (getActivity() != null && getActivity().findViewById(org.brainote.R.id.detail_title) != null) {
            Editable editableTitle = ((EditText) getActivity().findViewById(org.brainote.R.id.detail_title)).getText();
    ...
    private String getNoteContent() {
        ...
        if (!noteTmp.isChecklist()) {
            ...
            try {
                try {
                    content = ((EditText) getActivity().findViewById(org.brainote.R.id.detail_content)).getText().toString();
                } catch (ClassCastException e) {
                    content = ((android.widget.EditText) getActivity().findViewById(org.brainote.R.id.detail_content)).getText()
                            .toString();
                }
    ...
    private void lockUnlock() {
        ...
        if (prefs.getString(Constants.PREF_PASSWORD, null) == null) {
            getMainActivity().showMessage(org.brainote.R.string.password_not_set, ONStyle.WARN);

            return;
        }
        // Otherwise locking is performed
        if (noteTmp.isLocked()) {
            getMainActivity().showMessage(org.brainote.R.string.save_note_to_lock_it, ONStyle.INFO);
    ...
    private String initReminder(long reminderDateTime) {
        ...
        return getString(org.brainote.R.string.alarm_set_on) + " " + reminderDate + " " + getString(org.brainote.R.string.at_time)
                + " " + reminderTime;
    }
    ...
    private void playback(View v, Uri uri) {
        ...
        if (mPlayer != null && mPlayer.isPlaying()) {
            ...
            if (isPlayingView != v) {
                ...
                isPlayingView = v;
                startPlaying(uri);
                recordingBitmap = ((BitmapDrawable) ((ImageView) v.findViewById(org.brainote.R.id.gridview_item_picture))
                        .getDrawable()).getBitmap();
                ((ImageView) v.findViewById(org.brainote.R.id.gridview_item_picture)).setImageBitmap(ThumbnailUtils
                        .extractThumbnail(BitmapFactory.decodeResource(getActivity().getResources(),
                                org.brainote.R.drawable.stop), Constants.THUMBNAIL_SIZE, Constants.THUMBNAIL_SIZE));
            ...
            isPlayingView = v;
            startPlaying(uri);
            Drawable d = ((ImageView) v.findViewById(org.brainote.R.id.gridview_item_picture)).getDrawable();
            ...
            ((ImageView) v.findViewById(org.brainote.R.id.gridview_item_picture)).setImageBitmap(ThumbnailUtils.extractThumbnail
                    (BitmapFactory.decodeResource(getActivity().getResources(), org.brainote.R.drawable.stop),
        ...
        try {
            ...
            mPlayer.setOnCompletionListener(new OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer mp) {
                    mPlayer = null;
                    ((ImageView) isPlayingView.findViewById(org.brainote.R.id.gridview_item_picture)).setImageBitmap
                            (recordingBitmap);
    ...
    private void stopPlaying() {
        if (mPlayer != null) {
            ((ImageView) isPlayingView.findViewById(org.brainote.R.id.gridview_item_picture)).setImageBitmap(recordingBitmap);
            isPlayingView = null;
            recordingBitmap = null;
            mPlayer.release();
            mPlayer = null;
    ...
    private void fade(final View v, boolean fadeIn) {
        ...
        int anim = org.brainote.R.animator.fade_out_support;
        int visibilityTemp = View.GONE;

        if (fadeIn) {
            anim = org.brainote.R.animator.fade_in_support;
    ...
    private void addShortcut() {
        ...
        getMainActivity().showMessage(org.brainote.R.string.shortcut_added, ONStyle.INFO);
    }
    ...
    public void onTextLinkClick(View view, final String clickedString, final String url) {
        new MaterialDialog.Builder(getActivity())
                ...
                .positiveText(org.brainote.R.string.open)
                .negativeText(org.brainote.R.string.copy)
                .callback(new MaterialDialog.Callback() {
                    @Override
                    public void onPositive(MaterialDialog dialog) {
                        boolean error = false;
                        ...
                        if (intent == null
                            ...
                            getMainActivity().showMessage(org.brainote.R.string.no_application_can_perform_this_action,
                                    ONStyle.ALERT);
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_DOWN:
                ...
                Point displaySize = org.brainote.utils.Display.getUsableSize(getActivity());
                w = displaySize.x;
            ...
            case MotionEvent.ACTION_MOVE:
                if (swiping) {
                    ...
                    if (Math.abs(x - startSwipeX) > Constants.SWIPE_OFFSET) {
                        ...
                        transaction.replace(org.brainote.R.id.fragment_container, mDetailFragment,
    ...
    public void onGlobalLayout() {
        int screenHeight = org.brainote.utils.Display.getUsableSize(getActivity()).y;
        int heightDiff = screenHeight - org.brainote.utils.Display.getVisibleSize(root).y;
    ...
    private void shrinkLayouts(int heightDiff) {
        ViewGroup wrapper = ((ViewGroup) root.findViewById(org.brainote.R.id.detail_wrapper));
        if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_LANDSCAPE
                && !title.hasFocus()) {
            wrapper.removeView(titleCardView);
            heightDiff -= org.brainote.utils.Display.getStatusBarHeight(getActivity());
            if (orientationChanged) {
                orientationChanged = false;
                heightDiff -= org.brainote.utils.Display.getActionbarHeight(getActivity());
            }
        }
    ...
    public void onAttachingFileErrorOccurred(Attachment mAttachment) {
        getMainActivity().showMessage(org.brainote.R.string.error_saving_attachments, ONStyle.ALERT);
    ...
    public void onReminderPicked(long reminder) {
        ...
        if (mFragment.isAdded()) {
            datetime.setText(getString(org.brainote.R.string.alarm_set_on) + " " + DateHelper.getDateTimeShort(getActivity(),
                    reminder));
        }
    }
    ...
    private void addTags() {
        ...
        if (tags.size() == 0) {
            getMainActivity().showMessage(org.brainote.R.string.no_tags_created, ONStyle.WARN);
            return;
        }
        ...
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                .title(org.brainote.R.string.select_tags)
                .positiveText(org.brainote.R.string.ok)
    ...
    private class AttachmentOnClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                // Photo from camera
                case org.brainote.R.id.camera:
                    takePhoto();
                    attachmentDialog.dismiss();
                    break;
                case org.brainote.R.id.recording:
                    if (!isRecording) {
                        isRecording = true;
                        android.widget.TextView mTextView = (android.widget.TextView) v;
                        mTextView.setText(getString(org.brainote.R.string.stop));
                    ...
                    break;
                case org.brainote.R.id.video:
                    takeVideo();
                    attachmentDialog.dismiss();
                    break;
                case org.brainote.R.id.files:
                    Intent filesIntent;
                    ...
                    attachmentDialog.dismiss();
                    break;
                case org.brainote.R.id.sketch:
                    takeSketch(null);
                    attachmentDialog.dismiss();
                    break;
                case org.brainote.R.id.location:
                    setAddress();
                    attachmentDialog.dismiss();
                    break;
                case org.brainote.R.id.pushbullet:
                    MessagingExtension.mirrorMessage(getActivity(), getString(org.brainote.R.string.app_name),
                            getString(org.brainote.R.string.pushbullet),
                            getNoteContent(), BitmapFactory.decodeResource(getResources(), 
                                    org.brainote.R.drawable.ic_stat_notification_icon),
                            null, 0);
                    attachmentDialog.dismiss();
                    break;
            }
